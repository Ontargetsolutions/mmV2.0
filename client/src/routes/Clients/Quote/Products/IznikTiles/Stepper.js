...
import Patterns from "../Mosaics/Search";
import UpladPic from "../Mosaics/UploadPicture";
import GerneralQuestions from "./GeneralQuestions";
import Frames from "../Mosaics/Frames";
...
class VerticalLinearStepper extends React.Component {
  ...
  componentDidMount(){
    this.props.pickProduct('IznikTile');
  }
...
export default connect(mapStateToProps, { saveQuote, pickProduct })(VerticalLinearStepper);
