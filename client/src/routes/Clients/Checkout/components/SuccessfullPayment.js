              ...
              <div className="p-50">
                ...
                <div className="d-flex justify-content-between mb-30 add-full-card">
                  ...
                  <div className="add-card">
                    ...
                    <span>
                      {this.props.shippingAdreessCart.City} {this.props.shippingAdreessCart.Zip}
                    </span>
                ...
                <div className="order-status mb-30">
                  <span>Transaction Status: {this.props.paymentMessage.messages.message.text}</span>
                  <span>{this.props.paymentMessage.transactionResponse.messages.description}</span>
                  <span>Transaction Id: {this.props.paymentMessage.transactionResponse.networkTransId}</span>
                </div>
...
const mapStateToProps = ({quote, authUser, settings, ecommerce}) => {
  ...
  return {paymentMessage, shippingAdreessCart, actualQuote, cart};
};
