...
//quote
export const GET_ADOBE_STOCK_IMAGES = ' GET_ADOBE_STOCK_IMAGES';
export const GET_ADOBE_STOCK_IMAGES_SUCCESS = ' GET_ADOBE_STOCK_IMAGES_SUCCESS';
export const GET_ADOBE_STOCK_IMAGES_FAILURE = ' GET_ADOBE_STOCK_IMAGES_FAILURE';

export const PICK_PRODUCT = 'PICK_PRODUCT';
export const PICK_SERVICE = 'PICK_SERVICE';
export const PICK_ART_SOURCE = 'PICK_ART_SOURCE';
export const PICK_DIMENTIONS = 'PICK_DIMENTIONS';
export const PICK_QUANTITY = 'PICK_ QUANTITY';
export const PICK_IMAGE = 'PICK_IMAGE';
export const PICK_FRAME = 'PICK_FRAME';
export const PICK_THICKNESS = 'PICK_THICKNESS';
export const PICK_WIDTH = 'PICK_WIDTH';
export const PICK_LENGTH = 'PICK_LENGTH';
export const PICK_STYLE = 'PICK_STYLE';
export const PICK_TYPE = 'PICK_TYPE';
export const PICK_FINISH = 'PICK_FINISH';
export const PICK_HARDWOOD = 'PICK_HARDWOOD';
export const SELECT_ADDRESS = 'SELECT_ADDRESS';
export const PICK_PAYMENT_METHOD = 'PICK_PAYMENT_METHOD';

export const SAVE_IMAGE_UPLOADED = 'SAVE_IMAGE_UPLOADED';
...
export const GET_DELIVERY_FEE_FAILURE = 'GET_DELIVERY_FEE_FAILURE';
...
export const QUOTE_TO_VIEW = 'QUOTE_TO_VIEW';
export const QUOTE_MONEY_DATA = 'QUOTE_MONEY_DATA';
export const ORDER_PLACED = 'ORDER_PLACED';

export const GET_ALL_QUOTES_NO_COMPLETED = 'GET_ALL_QUOTES_NO_COMPLETED';
export const GET_ALL_QUOTES_NO_COMPLETED_SUCCESS= 'GET_ALL_QUOTES_NO_COMPLETED_SUCCESS';
export const GET_ALL_QUOTES_NO_COMPLETED_FAILURE = 'GET_ALL_QUOTES_NO_COMPLETED_FAILURE';

export const GET_ALL_QUOTES_COMPLETED = 'GET_ALL_QUOTES_COMPLETED';
export const GET_ALL_QUOTES_COMPLETED_SUCCESS= 'GET_ALL_QUOTES_COMPLETED_SUCCESS';
export const GET_ALL_QUOTES_COMPLETED_FAILURE = 'GET_ALL_QUOTES_COMPLETED_FAILURE';

export const GET_GALLERY_FILTER_CRITERIA = 'GET_GALLERY_FILTER_CRITERIA';

export const SET_LOADER_TRUE = 'SET_LOADER_TRUE';
export const SHOP_DONE_EMAIL = 'SHOP_DONE_EMAIL';
export const SHOP_DONE_EMAIL_SUCCESS = 'SHOP_DONE_EMAIL_SUCCESS';
export const SHOP_DONE_EMAIL_FAILURE = 'SHOP_DONE_EMAIL_FAILURE';

export const QUOTE_DONE_EMAIL = 'QUOTE_DONE_EMAIL';
export const QUOTE_DONE_EMAIL_SUCCESS = 'QUOTE_DONE_EMAIL_SUCCESS';
export const QUOTE_DONE_EMAIL_FAILURE = 'QUOTE_DONE_EMAIL_FAILURE';
...
export const GENERATE_INVOICE_NUMBER_SUCCESS = 'GENERATE_INVOICE_NUMBER_SUCCESS';
export const GENERATE_INVOICE_NUMBER_FAILURE = 'GENERATE_INVOICE_NUMBER_FAILURE';

export const OPEN_DIALOG_FOR_PAYMENT_ERROR = 'OPEN_DIALOG_FOR_PAYMENT_ERROR';
export const OPEN_DIALOG_FOR_INVOICE = 'OPEN_DIALOG_FOR_INVOICE';
